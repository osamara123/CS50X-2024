...
int find_min(void)
{
    ...
    //Bubble sort array from lower to higher
    for (int i = 0; i < candidate_count - 1; i++)
    {
        for (int j = 0; j < candidate_count - i - 1; j++)
        {
            ...
            {
                int temp1 = candidates [j].votes;
                string temp2 = candidates [j].name;
                bool temp3 = candidates [j].eliminated;
                ...
                candidates [j + 1].eliminated = temp3;
            }
        }
    }

    // get min value of votes
    for (int i = 0; i < candidate_count; i++)
    {
